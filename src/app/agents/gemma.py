...
def infer(
    ...
    role_instruction = (
        ...
        stable or worsening with respect to previous history if available 
        else write 'No previous history available to compare'. and provide reasoning for the same. & 
